...
public class PriorityTest_allNotPremium {
    @Test
    public void PriorityTest_allNotPremium() throws InterruptedException {
        ...
        subscribedProducts.put(new User("1", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("2", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("3", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("4", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("5", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("6", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("7", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("8", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("9", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
        subscribedProducts.put(new User("10", getRandomAge(), (long) getRandomId(), false), getRandomList(products));
